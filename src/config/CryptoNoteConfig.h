...
// Copyright (c) 2020, The ZecZero Developers
...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 1266114;
...
const char     CRYPTONOTE_NAME[]                             = "ZecZero";
...
const int      P2P_DEFAULT_PORT                              =  10007;
const int      RPC_DEFAULT_PORT                              =  10008;
...
const char     LATEST_VERSION_URL[]                          = "http://latest.getzeczero.xyz";
const std::string LICENSE_URL                                = "https://github.com/zeczero/zeczero/blob/master/LICENSE";
const static   boost::uuids::uuid CRYPTONOTE_NETWORK         =
{
    {  0xb5, 0x0c, 0x4a, 0x3c, 0xcf, 0x47, 0x22, 0x36, 0x36, 0xf9, 0x36, 0xa4, 0xb5, 0xc1, 0x43, 0xe9  }
};
